  ...
  <div class="p-6 max-w-4xl mx-auto bg-base-200 rounded-xl shadow-md space-y-4">
    ...
    <form on:submit={handleSubmit} class="space-y-6 w-full max-w-4xl">
      ...
      <div role="alert" class="alert bg-base-300">
        ...
        <span>Evaluate yourself using the following questions. Take your time and answer each question honestly and to the best of your knowledge.</span>
      </div>
          ...
          <div class="form-control">
            ...
            <div class="flex space-x-4 items-center">
                <label class="flex items-center space-x-2">
                  <input type="radio" bind:group={answers[index]} value="1" class="radio radio-primary" />
                  <span class="ml-1">Not at all</span>
                </label>
                <label class="flex items-center space-x-2">
                  <input type="radio" bind:group={answers[index]} value="2" class="radio radio-primary" />
                  <span class="ml-1">A little</span>
                </label>
                <label class="flex items-center space-x-2">
                  <input type="radio" bind:group={answers[index]} value="3" class="radio radio-primary" />
                  <span class="ml-1">Somewhat</span>
                </label>
                <label class="flex items-center space-x-2">
                  <input type="radio" bind:group={answers[index]} value="4" class="radio radio-primary" />
